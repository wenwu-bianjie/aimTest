...
var (
	...
	topic       = flag.String("topic", "test", "The topic to produce to")
	key         = flag.String("key", "test_format", "The key of the message to produce")
	value       = flag.String("value", `{"name": "test"}`, "The value of the message to produce")
