...
import (
	...
	"github.com/wenwu-bianjie/aimTest/demo2/consumergroup"
	"github.com/wvanbergen/kazoo-go"
)

const (
	DefaultKafkaTopics   = "demo"
	DefaultConsumerGroup = "demo_consumer_group"
)
...
var (
	...
	zookeeper      = flag.String("zookeeper", "localhost:2181", "A comma-separated Zookeeper connection string (e.g. `zookeeper1.local:2181,zookeeper2.local:2181,zookeeper3.local:2181`)")
...
func main() {
	...
	for message := range consumer.Messages() {
		...
		fmt.Printf("key:%s  value:%s/n", message.Key, message.Value)
